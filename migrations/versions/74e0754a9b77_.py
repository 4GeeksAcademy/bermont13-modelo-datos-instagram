...
Revision ID: 74e0754a9b77
Revises: a5cffa318ac2
Create Date: 2025-04-01 03:33:44.858658
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=True, primary_kay=True),
    sa.Column('post_id', sa.Integer(), nullable=True, primary_kay=True),
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], )
    )
